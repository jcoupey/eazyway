...
def get_filtered_data(access_token, org_id):
    ...
    for tile in tiles:
        ...
        filtered_geojson["features"].extend(
            [f for f in data["features"] if feature_ok(f, org_id)]
        )
...
if __name__ == "__main__":
    ...
    filtered_data = get_filtered_data(access_token, org_id)

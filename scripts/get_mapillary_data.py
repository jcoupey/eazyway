...
def feature_ok(f, org_id, image_id_blacklist):
    return (
...
def get_filtered_data(access_token, org_id, image_id_blacklist):
    ...
    for tile in tiles:
        ...
        filtered_geojson["features"].extend(
            [f for f in data["features"] if feature_ok(f, org_id, image_id_blacklist)]
        )
...
if __name__ == "__main__":
    ...
    filtered_data = get_filtered_data(access_token, org_id, image_id_blacklist)
